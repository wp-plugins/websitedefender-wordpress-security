	...
	*/
	...
	public static function loadResources()
	{
        ...
        if (ACX_SHOULD_LOAD)
		{
            ...
            wp_enqueue_script('acx-json', ACX_PLUGIN_PATH.'res/js/json.js');
            wp_enqueue_script('acx-md5', ACX_PLUGIN_PATH.'res/js/md5.js');
            wp_enqueue_script('acx-vf', ACX_PLUGIN_PATH.'res/js/acx-verify-form.js');
            wp_enqueue_script('acx-wsd', ACX_PLUGIN_PATH.'res/js/acx-wsd.js');
